...
@Component({
  selector: 'msp-entity-table',
  templateUrl: './msp-entity-table.component.html',
  styleUrls: ['./msp-entity-table.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [
    { provide: MatFormFieldControl, useExisting: MspEntityTableComponent }
  ]
})
export class MspEntityTableComponent implements OnInit, OnChanges, OnDestroy {
